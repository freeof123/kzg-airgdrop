...
library B12 {
  ...
  //     bytes memory input,
  //     uint256 offset
  // ) internal pure returns (G1Point memory ret) {
  ...
  //     bytes memory input,
  //     uint256 offset
  // ) internal pure returns (G2Point memory ret) {
  //     // unchecked sub is safe due to view validity checks
  //     bytes29 ref = input.ref(0).postfix(input.length - offset, 0);
  ...
  function g1MultiExp(
    ...
    bool success;
    assembly {
      success := staticcall(gasEstimate, precompile, add(input, 0x20), mul(mload(input), 0x20), add(input, 0x20), 128)
      // deallocate the input, leaving dirty memory
      mstore(0x40, input)
    }
...
library B12_381Lib {
  ...
  uint8 constant G1_ADD = 0x0b;
  uint8 constant G1_MUL = 0x0c;
  uint8 constant G2_ADD = 0x0d;
  uint8 constant G2_MUL = 0x0e;
  uint8 constant PAIRING = 0x0f;
  uint8 constant MAP_TO_G1 = 0x10;
  uint8 constant MAP_TO_G2 = 0x11;

  function P1() internal pure returns (B12.G1Point memory p) {
    ...
    p.Y.a = 11568204302792691131076548377920244452;
    p.Y.b = 114417265404584670498511149331300188430316142484413708742216858159411894806497;
  }
  ...
  function Q1() internal pure returns (B12.G2Point memory p) {
    p.X.a.a = 3045985886519456750490515843806728273;
    p.X.a.b = 89961632905173714226157479458612185649920463576279427516307505038263245192632;
    p.X.b.a = 26419286191256893424348605754143887205;
    p.X.b.b = 40446337346877272185227670183527379362551741423616556919902061939448715946878;
    p.Y.a.a = 17144095208600308495026432580569150746;
    p.Y.a.b = 78698209480990513415779284580404715789311803115477290401294577488850054555649;
    p.Y.b.a = 8010509799087472606393075511737879449;
    p.Y.b.b = 91929332261301883145239454754739358796115486554644188311284324629555800144318;
  }

  function negativeQ1() internal pure returns (B12.G2Point memory p) {
    p.X.a.a = 3045985886519456750490515843806728273;
    p.X.a.b = 89961632905173714226157479458612185649920463576279427516307505038263245192632;
    p.X.b.a = 26419286191256893424348605754143887205;
    p.X.b.b = 40446337346877272185227670183527379362551741423616556919902061939448715946878;
    p.Y.a.a = 17421388336814597573762763446246275004;
    p.Y.a.b = 82535940630695547964844822885348920226556672312706312698172214783216175252138;
    p.Y.b.a = 26554973746327433462396120515077546301;
    p.Y.b.b = 69304817850384178235384652711014277219752988873539414788182467642510429663469;
  }

  function kzgTrustedSetupG2_1() internal pure returns (B12.G2Point memory p) {
    p.X.a.a = 32383056032135852905016527803482769634;
    p.X.a.b = 25850360288623730545159955992210518030654433177743593292096773684352981786354;
    p.X.b.a = 28909894882549205682797441393143509897;
    p.X.b.b = 17231068747105440314693291718627530005204678724099931570750891240243864379250;
    p.Y.a.a = 1678810356811114306430970557124181154;
    p.Y.a.b = 8631774564376111186730175879406191017399655017429796552026393504830885931673;
    p.Y.b.a = 29776631766798495942938431669604457291;
    p.Y.b.b = 108318091763146948287453871648009529003743209242393561278652848344399168017743;
  }
